package com.evil.inc.subscriptionnews.architecture;
...
@AnalyzeClasses(packages = "com.evil.inc.subscriptionnews", importOptions = ImportOption.DoNotIncludeTests.class)
